...
ent-HighSecArmoryLocked = { ent-HighSecDoor }
    .suffix = Оружейная, Закрыт
    .desc = { ent-HighSecDoor.desc }
ent-AirlockExternalExpeditionLocked = { ent-AirlockShuttle }
    .suffix = Стыковочный, Экспедиция
    .desc = { ent-AirlockShuttle.desc }
ent-AirlockExternalGlassExpeditionLocked = { ent-AirlockGlassShuttle }
    .suffix = Стеклянный, Закрытый, Экспедиция
    .desc = { ent-AirlockGlassShuttle.desc }
ent-AirlockExternalShuttleExpeditionLocked = { ent-AirlockShuttle }
    .suffix = Стыковочный, Закрытый, Экспедиция
    .desc = { ent-AirlockShuttle.desc }
ent-AirlockExternalGlassShuttleExpeditionLocked = { ent-AirlockGlassShuttle }
    .suffix = Стеклянный, Стыковочный, Закрытый, Экспедиция
    .desc = { ent-AirlockGlassShuttle.desc }