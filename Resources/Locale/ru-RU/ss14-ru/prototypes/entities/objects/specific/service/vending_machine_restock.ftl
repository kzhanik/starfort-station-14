...
ent-VendingMachineRestockFreightforwardersExpiditorsEquipment = набор пополнения ЭкспидиторМаг
    .desc = Вы действительно решили растачивать имущество NanoTrasen?
    .suffix = { "" }
ent-VendingMachineRestockExpiditorsDrobeEquipment = набор пополнения ЭкспиШкаф
    .desc = Коробка, наполненная различной одеждой для экспидиторов.
    .suffix = { "" }
